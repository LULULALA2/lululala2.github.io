...
* 사용자 편의성 증진
    ...
    * index.html로 돌아왔을 때 로그인을 다시 해야하는 경우 방지 ([해결과정](#1.-index.html로-돌아왔을-때-로그인을 다시해야하는-경우-방지))  
...
```
# settings.py  
FILE_UPLOAD_MAX_MEMORY_SIZE = 5242880</blockquote>
```

[블로그에 남겼던 기록](https://lululala-2.tistory.com/141?category=1017710)
